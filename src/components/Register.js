...
export default class Register extends Component {
   ...
   setUser() {
        ...
        axios.post('http://localhost:4200/api/form',{
            // name,
            // email,
            // contact
        }).then(response=>{
        ...
        axios.post('http://localhost:4000/users', newCustomer)
            ...
            <Wrapper ImagePath={this.props.ImagePath}>
               <center> <h3>Welcome New User</h3></center>
                ...
                <form>
                    ...
                    <center>
                    <p>Please Double click to submit this form</p>
                    <div className="form-group mx-sm-4 mb-4">
                        <input type="button" value="Submit" onClick={()=>{
                            this.setUser();
                            value.getRegistered(this.state.emailIsValid && this.state.nameIsValid);
